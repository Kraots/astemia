...
class Database:
    def __init__(self):
        ...
        self.all_collections = [
            Intro, Rules, Mutes, Level,
            InvalidName, Marriage, Ticket, AFK,
            Game, Characters, GiveAway, Birthday,
            BadWords, Constants, Reminder, ToDo,
            Sober, BDSM, Poll, Stats, Warns, Tags, Restrictions
        ]
